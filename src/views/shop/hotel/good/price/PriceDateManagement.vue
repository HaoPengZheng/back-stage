  ...
  <div class="card-list" ref="content">
                ...
                <a-card-meta>
                  ...
                  <div class="meta-content" slot="description">
                    ...
                    <div v-if="item.type==2">
                      <div>
                        日期：
                        <a @click="previewDateData(item.id)">预览</a>
                      </div>
                    </div>
        ...
        <a-row :gutter="16">
          ...
          <a-col :span="24">
            <a-form-item label="等级">
              <a-input-number style="width: 100%" v-model="level" />
            </a-form-item>
          </a-col>
        </a-row>
    ...
    >
      <a-row type="flex" justify="space-between" style="padding-bottom:50px;">
        <div class="date-picker-item" v-for="item in previewDateOption" :key="item.toString()">
...
export default {
  ...
  computed: {
    dataSource() {
      let dataSource = this.daterulesData
        .map(ele => {
          if (ele === null) {
            return ele;
          } else {
