            ...
            <a-col :span="14">
              ...
              <a-form-item :label-col="{ span: 3 }" :wrapper-col="{ span: 16 }" label="职位">
                <a-cascader
                  ...
                  v-decorator="['role', { initialValue:['institution-133','role-481'],rules: [{ required: true, message: '职位是必须要填的!'}]}]"
                />
              </a-form-item>
              <a-form-item :label-col="{ span: 3 }" :wrapper-col="{ span: 16 }" label="账号">
                <a-input
                  placeholder="员工登录的账号"
                  v-decorator="['account', {initialValue:`dayWorker${new Date().getTime()}`, rules: [{ required: true, message: '账号是必须要填的(将作为员工查数据使用)!'}]}]"
                />
              </a-form-item>
              ...
              <a-form-item :label-col="{ span: 3 }" :wrapper-col="{ span: 16 }" label="到职日期">
                <a-date-picker
                  showTime
                  v-decorator="['EOD', {  initialValue:this.$moment(new Date()),rules: []}]"
                ></a-date-picker>
              </a-form-item>
              <a-form-item
                :label-col="{ span: 3 }"
              ...
              >
                <a-date-picker
                  showTime
                  v-decorator="['TermDate', {  initialValue:this.$moment( new Date(new Date(new Date().toLocaleDateString()).getTime() +24 * 60 * 60 * 1000 -1)),rules: [{ required:false}]}]"
                ></a-date-picker>
              </a-form-item>
            </a-col>
            <a-col :span="10">
